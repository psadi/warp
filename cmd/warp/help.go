...
func printUsage() {
	...
	fmt.Println("  warp self-upgrade         Upgrade to latest version")
	fmt.Println("  warp version              Show version")
	fmt.Println()
...
func printUpgradeHelp() {
	fmt.Println("Upgrade warp to the latest version")
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  warp self-upgrade")
	fmt.Println()
	fmt.Println("Options:")
	fmt.Println("  --help, -h              Show this help")
	fmt.Println()
	fmt.Println("Uses GitHub releases to download and install the latest version.")
}
